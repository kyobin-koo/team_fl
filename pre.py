...
# 그래프 시각화
plt.figure(figsize=(12, 6))
plt.plot(ranking_comparison['carrier'], ranking_comparison['rank_avg'], marker='o', linestyle='-', label='Avg Delay Rank')
...
a330_models_df = df[df['model'].str.startswith('A330', na=False)]
